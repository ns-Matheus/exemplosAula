...
function criarReceita() {
   Swal.fire({
      ...
      html: '<div class="w-100">' +
         ...
         '<input class="w-25" type="text" id="criarReceita3" placeholder="tempo de craft 00:00:00" />' +
         '</div>' +
         '</div>' +
         '</div>',
      showCancelButton: true,
      ...
      if (result.isConfirmed) {
         fetch("http://monkey_craft/craftRecipe", {
            ...
            body: JSON.stringify({
               ...
               id_craft: app.recipeSelected.id_craft,
