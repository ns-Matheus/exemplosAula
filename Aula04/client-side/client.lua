    ...
    while true do   
        ...
        local coords = GetEntityCoords(ped) 
            ...
            if distance < 20 then  
                ...
                if i == 2 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,255,255,255,100,0,0,0,1)
                end
                if i == 3 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,56,168,63,100,0,0,0,1)
                end
                if i == 4 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,218, 93, 86,100,0,0,0,1)
                end
                if i == 5 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,35, 228, 192,100,0,0,0,1)
                end
                if i == 6 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,51, 70, 252,100,0,0,0,1)
                end
                if i == 7 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,123, 120, 123,100,0,0,0,1)
                end
                if i == 8 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,191, 126, 217,100,0,0,0,1)
                end
                if i == 9 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,69, 55, 50,100,0,0,0,1)
                end
                if i == 10 then
                    DrawMarker(2, blip[i].x,blip[i].y,blip[i].z,0,0,0,0,0,0,1.53,0.77,0.89,205, 224, 50,100,0,0,0,1)
                end
                time = 1
